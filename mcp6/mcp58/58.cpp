...
class graph {
	...
	n
	eighbor_list_type const & neighbors(Vertex const & v) const {
	...
	c
	onstexpr
	static Weight Infinity = std::numeric_limits < Weight > ::infinity();
private:
